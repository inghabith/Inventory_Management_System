...
from FEATURE_SAVE_CSV import save_csv
from FEATURE_LOAD_CSV import load_csv

# Shared inventory used across all modules
products_list = []
path = "products.csv"
...
➤  """))
    ...
    if Option == 7:
        save_csv(products_list, path)
    if Option == 8:
        load_csv(products_list, path)
    if Option == 9:
        print("Goodbye")
        break
